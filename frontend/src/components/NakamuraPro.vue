  ...
  <div>
    <div style="display: flex; align-items: center; height: 100vh; flex-direction: column;">
      <div style="display: flex; align-items: center;">
        <img src="/assets/nakamura.png" alt="画像" style="width: 150px; height: 150px;">
        <h1 style="margin-left: 10px;">Nakamura<br>recommended Protein</h1>
      </div>
      <div>
        <div v-for="fav in favs" :key="fav.id">
          ...
          <div style="width: 200px; height: 150px; margin-left: 50px;">
            ...
            <h2>
              <router-link :to="{name:'detail',params:{ id: 104}}">
...
export default {
  ...
  mounted() {
    Service.get('/detail/' + 104).then(response => {
